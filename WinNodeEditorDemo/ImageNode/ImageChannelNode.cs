...
namespace WinNodeEditorDemo.ImageNode
{
    ...
    public class ImageChannelNode : ImageBaseNode
    {
        ...
        {
            base.OnCreate();
            Width = base.Width + 20; Height = base.Height + 20;
            Title = "ImageChannel";

            m_op_img_in = InputOptions.Add("", typeof(Image), true);
            m_op_img_r = OutputOptions.Add("R", typeof(Image), false);
            m_op_img_g = OutputOptions.Add("G", typeof(Image), false);
            m_op_img_b = OutputOptions.Add("B", typeof(Image), false);
            //当输入节点有数据输入时候
        ...
        private void m_op_img_in_DataTransfer(object sender, STNodeOptionEventArgs e)
        {
            ...
            else
            {
                ...
                Bitmap bmp_r = new(bmp.Width, bmp.Height);
                Bitmap bmp_g = new(bmp.Width, bmp.Height);
                Bitmap bmp_b = new(bmp.Width, bmp.Height);
