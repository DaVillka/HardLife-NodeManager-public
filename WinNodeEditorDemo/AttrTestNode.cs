...
namespace WinNodeEditorDemo
{
    ...
    public class AttrTestNode : STNode
    {
        ...
        public AttrTestNode()
        {
            ...
            _ = base.InputOptions.Add("string", typeof(string), false);
            _ = base.OutputOptions.Add("string", typeof(string), false);
            Title = "AttrTestNode";
        ...
        {
            _ = MessageBox.Show("this is -> ShowHelpInfo(string);\r\n" + strFileName);
        }
        ...
        protected override void OnOwnerChanged()
        {
            ...
            _ = Owner.SetTypeColor(typeof(string), Color.Goldenrod);
        }
    }
    /// <summary>
