...
namespace HardLife_Options.Extensions
{
	public class ToolStripRendererEx : ToolStripRenderer
	{
		private readonly SolidBrush m_brush = new SolidBrush(Color.FromArgb(255, 52, 86, 141));
		private readonly StringFormat m_sf = new StringFormat();
