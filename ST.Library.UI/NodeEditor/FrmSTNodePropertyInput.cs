...
namespace ST.Library.UI
{
    internal class FrmSTNodePropertyInput : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            m_tbx = new TextBox
            {
                Font = m_descriptor.Control.Font,
                ForeColor = m_descriptor.Control.ForeColor,
                BackColor = Color.FromArgb(255, m_descriptor.Control.ItemValueBackColor),
                BorderStyle = BorderStyle.None,

                Size = new Size(Width - 4 - m_rect.Height, Height - 2),
                Text = m_descriptor.GetStringFromValue()
            };
            Controls.Add(m_tbx);
