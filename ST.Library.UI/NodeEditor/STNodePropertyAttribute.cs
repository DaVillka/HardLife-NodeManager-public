...
namespace ST.Library.UI.NodeEditor
{
    ...
    public class STNodePropertyAttribute : Attribute
    {
        ...
        /// 获取属性描述器类型
        /// </summary>
        public Type DescriptorType { get; set; } = typeof(STNodePropertyDescriptor);
    ...
    public class STNodePropertyDescriptor
    {
        ...
        private static readonly Type m_t_int = typeof(int);
        private static readonly Type m_t_float = typeof(float);
        private static readonly Type m_t_double = typeof(double);
        private static readonly Type m_t_string = typeof(string);
        ...
        {
            object v = PropertyInfo.GetValue(Node, null);
            Type t = PropertyInfo.PropertyType;
            if (v == null)
            {
                return null;
        ...
        protected internal virtual byte[] GetBytesFromValue()
        {
            ...
            return strText == null ? null : Encoding.UTF8.GetBytes(strText);
        }
        /// <summary>
        ...
        protected internal virtual void OnMouseClick(MouseEventArgs e)
        {
            ...
            _ = Control.RectangleToScreen(RectangleR);
