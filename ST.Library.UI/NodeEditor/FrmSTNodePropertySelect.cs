...
namespace ST.Library.UI.NodeEditor
{
    internal class FrmSTNodePropertySelect : Form
    {
        ...
        private readonly List<object> m_lst_item = new List<object>();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                foreach (object v in Enum.GetValues(m_descriptor.PropertyInfo.PropertyType))
                {
                    m_lst_item.Add(v);
                }
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (object v in m_lst_item)
            {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            object item = m_lst_item[e.Y / m_nItemHeight];
